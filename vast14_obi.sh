...
git clone git clone https://github.com/obi-wan-xenobi/XENGPUMiner.git
sleep 5
echo "---------------------------"
...
sed -i 's/account = 0x24691e54afafe2416a8252097c9ca67557271475/account = 0x1fEA0Bcf3587DFA7972A0b990Db9ccACe08DD879/g' config.conf
sleep 5
echo "---------------------------"
...
sleep 5
echo "---------------------------"
sudo nohup ./xengpuminer -d10 > xengpuminer-12.log 2>&1 &
sleep 5
echo "---------------------------"
  
sudo nohup ./xengpuminer -d11 > xengpuminer-13.log 2>&1 &
sleep 5
echo "---------------------------"
